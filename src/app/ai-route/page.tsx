...
type Interest = "culture" | "food" | "nature" | "activity" | "cafe" | "unseen" | "shopping";
...
const startingAreas: StartingArea[] = [
  { id: "chiang-mai-old-city", name: "Chiang Mai Old City", province: "Chiang Mai", region: "North", baseFare: 900 },
  { id: "nimman", name: "Nimman", province: "Chiang Mai", region: "North", baseFare: 850 },
  { id: "mae-rim", name: "Mae Rim", province: "Chiang Mai", region: "North", baseFare: 1050 },
  { id: "mae-on", name: "Mae On", province: "Chiang Mai", region: "North", baseFare: 1150 },
  { id: "chiang-rai-clock", name: "Chiang Rai Clock Tower", province: "Chiang Rai", region: "North", baseFare: 950 },
  { id: "bangkok-riverside", name: "Bangkok Riverside", province: "Bangkok", region: "Central", baseFare: 750 },
  { id: "ari", name: "Ari", province: "Bangkok", region: "Central", baseFare: 700 },
  { id: "ayutthaya-park", name: "Ayutthaya Historical Park", province: "Ayutthaya", region: "Central", baseFare: 850 },
  { id: "phuket-old-town", name: "Phuket Old Town", province: "Phuket", region: "South", baseFare: 900 },
  { id: "ao-nang", name: "Ao Nang", province: "Krabi", region: "South", baseFare: 1000 },
];
...
const places: Place[] = [
  {
    ...
    time: "08:30",
    duration: 90,
    image: "https://images.unsplash.com/photo-1574360721200-d86cc841d13f?q=80&w=1000&auto=format&fit=crop",
    tags: ["culture", "unseen"],
    cost: "low",
    crowd: "popular",
    distanceKm: 16,
    ...
    description: "A sunrise temple stop with a strong cultural anchor and wide city views.",
    localTip: "Go before 9 AM, then continue down the mountain before traffic builds.",
  },
  {
    id: "baan-kang-wat",
    title: "Baan Kang Wat",
    ...
    time: "10:45",
    duration: 75,
    image: "https://images.unsplash.com/photo-1603512882194-d106603de801?q=80&w=1000&auto=format&fit=crop",
    ...
    description: "A creative village with craft studios, local design shops, and slow cafes.",
    localTip: "Ask a local maker for the small ceramics studio behind the main courtyard.",
  },
  {
    ...
    time: "12:20",
    duration: 55,
    image: "https://images.unsplash.com/photo-1626804475297-41609ea004eb?q=80&w=1000&auto=format&fit=crop",
    tags: ["food", "unseen"],
    cost: "low",
    crowd: "popular",
    distanceKm: 2,
    routeOrder: 3,
    startAreaIds: ["chiang-mai-old-city", "nimman"],
    description: "A compact lunch stop for Northern curry noodles near the city wall.",
    localTip: "The agent schedules lunch early because the signature bowls often sell out.",
  },
  {
    id: "wat-umong",
    ...
    routeOrder: 4,
    startAreaIds: ["chiang-mai-old-city", "nimman"],
    description: "A forest temple with ancient brick tunnels and a calm walking loop.",
    localTip: "Pair it with Doi Suthep or Baan Kang Wat to reduce backtracking.",
  },
  {
    id: "mae-kampong",
    ...
    description: "A mountain village route for forest air, streams, cafes, and homestay culture.",
    localTip: "Use a verified driver for the climb; fixed fare protects tourists from surge quotes.",
  },
  {
    id: "sticky-waterfall",
    ...
    time: "13:30",
    duration: 120,
    image: "https://images.unsplash.com/photo-1601662528567-526cd06f6582?q=80&w=1000&auto=format&fit=crop",
    ...
    description: "A light adventure stop where limestone grip makes the waterfall climbable.",
    localTip: "The agent groups this with northbound stops so transport remains fair and efficient.",
  },
  {
    id: "mon-jam",
    ...
    description: "Mountain viewpoints, flower gardens, and cafes clustered into one scenic route.",
  ...
  },
  {
    ...
    routeOrder: 1,
    startAreaIds: ["chiang-mai-old-city", "nimman", "mae-rim"],
    description: "A local market for breakfast, craft products, coffee, and Thai design goods.",
  ...
  },
  {
    ...
    description: "A garden route with canopy walk, glasshouses, mountain air, and easy nature stops.",
  ...
  },
  {
    ...
    routeOrder: 2,
    startAreaIds: ["mae-rim"],
    description: "A tiered waterfall stop close to Mae Rim with shaded trails and picnic corners.",
    localTip: "Wear shoes with grip; some lower tiers can be slippery after rain.",
  },
  {
    ...
    routeOrder: 2,
    startAreaIds: ["mae-on"],
    description: "A relaxed hot spring stop with mineral baths, gardens, and easy family activities.",
    localTip: "Buy eggs at the entrance if you want the classic hot-spring snack.",
  },
  {
    id: "teen-tok-project",
    ...
    routeOrder: 3,
    startAreaIds: ["mae-on"],
    description: "A quiet project stop near Mae Kampong with forest paths, coffee, and local produce.",
  ...
  },
  {
    ...
    description: "A contemporary temple landmark with strong visual storytelling.",
    localTip: "Visit early, then route toward Singha Park before the tour buses peak.",
  },
  {
    id: "blue-temple",
    ...
    routeOrder: 2,
    startAreaIds: ["chiang-rai-clock"],
    description: "A vivid blue temple stop that fits neatly into a short Chiang Rai cultural loop.",
    localTip: "The coconut ice cream nearby is a good quick break before lunch.",
  },
  {
    id: "singha-park",
    title: "Singha Park",
    ...
    routeOrder: 3,
    startAreaIds: ["chiang-rai-clock"],
    description: "A relaxed park route with cycling, tea fields, viewpoints, and food stops.",
    localTip: "Reserve bikes on busy days; it turns the stop into an easy activity match.",
  },
  {
    id: "talat-noi",
    ...
    description: "A walkable neighborhood for street art, old shophouses, coffee, and river alleys.",
  ...
  },
  {
    ...
    description: "A dense local food market across the river from the Grand Palace area.",
    localTip: "The agent keeps it at lunch because most snack stalls are fully open.",
  },
  {
    id: "moca",
    title: "MOCA Bangkok",
    ...
    time: "14:30",
    duration: 120,
    image: "https://images.unsplash.com/photo-1545987796-200677ee1011?q=80&w=1000&auto=format&fit=crop",
    tags: ["culture", "activity"],
    cost: "medium",
    crowd: "quiet",
    distanceKm: 12,
    routeOrder: 3,
    startAreaIds: ["ari"],
    description: "A quieter modern art stop that works well after cafe or market routes.",
    localTip: "Use a fixed ride from Ari; public transport plus walk is slower in heat.",
  },
  {
    id: "chatuchak",
    ...
    routeOrder: 1,
    startAreaIds: ["ari"],
    description: "A huge market for Thai fashion, snacks, souvenirs, and home goods.",
    localTip: "The agent limits nearby stops after this because the market can drain energy fast.",
  },
  {
    id: "wat-mahathat",
    title: "Wat Mahathat",
    ...
    description: "A core historical stop with temple ruins and the famous Buddha head in tree roots.",
    localTip: "Start here before heat and group tours fill the narrow photo spots.",
  },
  {
    id: "ayutthaya-boat",
    ...
    routeOrder: 3,
    startAreaIds: ["ayutthaya-park"],
    description: "A late afternoon river loop that connects temples from a cooler, scenic angle.",
    localTip: "Book fixed-price boats through the platform to avoid pier quote surprises.",
  },
  {
    id: "ban-mai-rim-nam",
    ...
    time: "12:10",
    duration: 70,
    image: "https://images.unsplash.com/photo-1569058242567-93de6f36f8eb?q=80&w=1000&auto=format&fit=crop",
    ...
    routeOrder: 2,
    startAreaIds: ["ayutthaya-park"],
    description: "A riverside lunch stop with old-house atmosphere and local dishes.",
  ...
  },
  {
    ...
    routeOrder: 3,
    startAreaIds: ["ayutthaya-park"],
    description: "A riverside temple ruin that works beautifully before a sunset boat loop.",
  ...
  },
  {
    ...
    description: "A colorful Sino-Portuguese walking route with cafes, murals, and local snacks.",
    localTip: "Start on Thalang Road, then cut into side streets before the heat.",
  },
  {
    id: "chillva-market",
    ...
    time: "18:00",
    duration: 120,
    image: "https://images.unsplash.com/photo-1533630757306-cbadb934bcb1?q=80&w=1000&auto=format&fit=crop",
    ...
    routeOrder: 3,
    startAreaIds: ["phuket-old-town"],
    description: "A night market stop for food, fashion, music, and low-pressure social energy.",
    localTip: "This is a good buddy-match stop because groups can split snacks and rides.",
  },
  {
    id: "laem-krating",
    ...
    routeOrder: 2,
    startAreaIds: ["phuket-old-town"],
    description: "A coastal viewpoint hike with a wilder feel than the standard beach route.",
    localTip: "Use a guide if sunset hiking; the return path gets dark quickly.",
  },
  {
    id: "rang-hill",
    ...
    routeOrder: 2,
    startAreaIds: ["phuket-old-town"],
    description: "A nearby hill viewpoint with city views, breezy cafes, and a short scenic ride.",
  ...
  },
  {
    ...
    routeOrder: 3,
    startAreaIds: ["phuket-old-town"],
    description: "A lively Old Town market for local snacks, crafts, music, and evening walking.",
  ...
  },
  {
    ...
    description: "A boat-access beach route for limestone cliffs, caves, swimming, and climbing.",
    localTip: "The agent checks tide windows before pairing Railay with other stops.",
  },
  {
    id: "dragon-crest",
    ...
    routeOrder: 1,
    startAreaIds: ["ao-nang"],
    description: "A serious morning hike with one of Krabi's strongest viewpoints.",
    localTip: "Packed routes should skip extra hikes after this; it is a real workout.",
  },
  {
    ...
    routeOrder: 3,
    startAreaIds: ["ao-nang"],
    description: "An evening market route for street food, crafts, and local performances.",
    localTip: "Pair it with a fair-fare return ride because late taxis can overquote tourists.",
  },
];

const distanceOverrides: Record<string, Partial<Record<string, number>>> = {
  "doi-suthep": { "chiang-mai-old-city": 16, nimman: 13, "mae-rim": 28, "mae-on": 55 },
  "baan-kang-wat": { "chiang-mai-old-city": 6, nimman: 4, "mae-rim": 24, "mae-on": 44 },
  "khao-soi-khun-yai": { "chiang-mai-old-city": 1.5, nimman: 4.5, "mae-rim": 23, "mae-on": 42 },
  "wat-umong": { "chiang-mai-old-city": 7, nimman: 5, "mae-rim": 25, "mae-on": 45 },
  "mae-kampong": { "mae-on": 18, "chiang-mai-old-city": 52, nimman: 55, "mae-rim": 72 },
  "sticky-waterfall": { "mae-rim": 45, "chiang-mai-old-city": 60, nimman: 58, "mae-on": 83 },
  "mon-jam": { "mae-rim": 21, nimman: 38, "chiang-mai-old-city": 40, "mae-on": 78 },
  "jing-jai-market": { "chiang-mai-old-city": 4, nimman: 5, "mae-rim": 21, "mae-on": 41 },
  "queen-sirikit-botanic": { "mae-rim": 14, nimman: 31, "chiang-mai-old-city": 33 },
...
const provinceDistanceKm: Record<string, Record<string, number>> = {
  "Chiang Mai": { "Chiang Rai": 190, Bangkok: 695, Ayutthaya: 620, Phuket: 1510, Krabi: 1450 },
  "Chiang Rai": { "Chiang Mai": 190, Bangkok: 785, Ayutthaya: 710, Phuket: 1600, Krabi: 1540 },
  Bangkok: { "Chiang Mai": 695, "Chiang Rai": 785, Ayutthaya: 82, Phuket: 840, Krabi: 780 },
  Ayutthaya: { Bangkok: 82, "Chiang Mai": 620, "Chiang Rai": 710, Phuket: 900, Krabi: 830 },
  Phuket: { Krabi: 165, Bangkok: 840, Ayutthaya: 900, "Chiang Mai": 1510, "Chiang Rai": 1600 },
  Krabi: { Phuket: 165, Bangkok: 780, Ayutthaya: 830, "Chiang Mai": 1450, "Chiang Rai": 1540 },
};
...
const placeDetails: Record<string, PlaceDetail> = {
  "doi-suthep": {
    ...
    transportNote: "Mountain road. Use a fixed fare car or red truck from the city.",
  ...
  "mae-kampong": {
    ...
    transportNote: "Use a verified driver for mountain roads and fixed pricing.",
  ...
  "mon-jam": {
    ...
    transportNote: "Mountain route from Mae Rim; fixed fare avoids return overpricing.",
  ...
  "queen-sirikit-botanic": {
    ...
    transportNote: "Best by private car from Mae Rim; parking available inside the garden.",
  ...
  "mae-sa-waterfall": {
    ...
    transportNote: "Short ride from Mae Rim; combine with botanic garden in one loop.",
  ...
  "white-temple": {
    ...
    transportNote: "Fixed taxi from Clock Tower works well for a half-day loop.",
  ...
  chatuchak: {
    ...
    transportNote: "BTS Mo Chit/MRT Chatuchak Park; fixed ride for hotel return.",
  ...
  "ayutthaya-boat": {
    ...
    transportNote: "Book fixed price before boarding to avoid pier quote surprises.",
  ...
  "phuket-sunday-market": {
    ...
    transportNote: "Walkable from Old Town stays; use fixed ride after market close.",
...
const guides: Guide[] = [
  { name: "Nicha", province: "Chiang Mai", tags: ["culture", "cafe", "unseen"], languages: ["Thai", "English"], verification: "Passport + face check", rate: 1200 },
  { name: "Arun", province: "Chiang Mai", tags: ["food", "culture"], languages: ["Thai", "Chinese"], verification: "Citizen ID + OTP", rate: 950 },
  { name: "Mali", province: "Chiang Rai", tags: ["nature", "culture"], languages: ["Thai", "English", "Japanese"], verification: "Citizen ID + face check", rate: 1100 },
  { name: "Beam", province: "Bangkok", tags: ["food", "shopping", "unseen"], languages: ["Thai", "English"], verification: "Passport + OTP", rate: 1000 },
  { name: "Fah", province: "Ayutthaya", tags: ["culture", "activity"], languages: ["Thai", "English", "French"], verification: "Citizen ID + face check", rate: 1050 },
  { name: "Suda", province: "Phuket", tags: ["culture", "food", "shopping"], languages: ["Thai", "English", "Russian"], verification: "Citizen ID + OTP", rate: 1300 },
  { name: "Ken", province: "Krabi", tags: ["nature", "activity", "unseen"], languages: ["Thai", "English"], verification: "Passport + face check", rate: 1400 },
];

const buddies: Buddy[] = [
  { name: "Mina", nationality: "Japan", language: "Japanese", tags: ["culture", "cafe"], budget: "medium" },
  { name: "Lucas", nationality: "France", language: "English", tags: ["nature", "activity"], budget: "medium" },
  { name: "May", nationality: "Thailand", language: "Thai", tags: ["food", "shopping"], budget: "low" },
  { name: "Chen", nationality: "China", language: "Chinese", tags: ["culture", "food"], budget: "medium" },
  { name: "Sofia", nationality: "Spain", language: "English", tags: ["unseen", "nature"], budget: "premium" },
  { name: "Noah", nationality: "United States", language: "English", tags: ["activity", "food"], budget: "medium" },
  { name: "Anna", nationality: "Germany", language: "English", tags: ["culture", "unseen"], budget: "low" },
  { name: "Ploy", nationality: "Thailand", language: "Thai", tags: ["cafe", "shopping"], budget: "low" },
  { name: "Camille", nationality: "France", language: "French", tags: ["culture", "food"], budget: "medium" },
  { name: "Irina", nationality: "Russia", language: "Russian", tags: ["nature", "shopping"], budget: "premium" },
];
...
function scoreSearchText(place: Place, query: string) {
  ...
  return normalizedQuery
    .split(/\s+/)
    .filter(Boolean)
    .reduce((score, word) => score + (searchableText.includes(word) ? 22 : 0), 0);
}
...
function scorePlace(place: Place, startArea: StartingArea, interests: Interest[], budget: Budget, query: string, distanceKm: number) {
  const interestScore = place.tags.filter((tag) => interests.includes(tag)).length * 26;
  ...
  const quietScore = place.crowd === "quiet" ? 8 : place.crowd === "moderate" ? 4 : -2;
  const routeScore = 9 - place.routeOrder;
  const distancePenalty = Math.min(distanceKm / 8, 70);

  return Math.round(
    interestScore + directStartScore + provinceScore + budgetScore + searchScore + unseenScore + quietScore + routeScore - distancePenalty,
  );
}
...
export default function AIRoutePlanner() {
  ...
  const [interests, setInterests] = useState<Interest[]>(["culture", "food", "unseen"]);
  ...
  const [statusMessage, setStatusMessage] = useState("Showing route matches for temple food unseen.");

  const startArea = startingAreas.find((area) => area.id === startAreaId) ?? startingAreas[0];
      ...
      [...places]
        .map((place) => {
          ...
          return {
            ...place,
            distanceKm,
            match: scorePlace(place, startArea, interests, budget, searchQuery, distanceKm),
          };
        })
        ...
        .sort((a, b) => a.routeOrder - b.routeOrder || a.distanceKm - b.distanceKm),
    [budget, interests, pace, searchQuery, startArea],
  );

  const selectedStop = recommendedStops.find((stop) => stop.id === selectedStopId) ?? null;
  const selectedPlaceDetail = selectedStop ? getPlaceDetail(selectedStop) : null;
  const topInterests = interestOptions
    .filter((option) => interests.includes(option.value))
    .map((option) => option.label)
    .join(", ");

  const totalMinutes = recommendedStops.reduce((sum, stop) => sum + stop.duration, 0);
  const totalKm = recommendedStops.reduce((sum, stop) => sum + stop.distanceKm, 0);
  const fairFare = Math.round(startArea.baseFare + totalKm * 18 + recommendedStops.length * 70);
  ...
  const searchRoute = () => {
    ...
    window.setTimeout(() => {
      ...
      setStatusMessage(nextQuery ? `Showing nearby route matches for ${nextQuery}.` : "Showing nearby route matches from selected filters.");
  ...
  const saveTrip = () => {
    ...
    setSavedTrips((current) => (current.includes(tripName) ? current : [tripName, ...current].slice(0, 4)));
  ...
  const requestGuide = (guideName: string) => {
    setStatusMessage(`Guide request sent to ${guideName}. Waiting for confirmation.`);
  };

  const joinBuddy = (buddyName: string) => {
    setStatusMessage(`Buddy invite sent to ${buddyName}. Shared activity created.`);
  };

  const bookDriver = () => {
    setStatusMessage(`Fair ride reserved at ${fairFare.toLocaleString()} THB with OTP pickup.`);
  };
      ...
      <main className="container mx-auto max-w-7xl px-4 pb-20 pt-28 md:px-6">
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="font-heading text-4xl font-extrabold md:text-5xl">{dict.pages.aiRoute.title}</h1>
            <p className="mt-2 max-w-2xl text-lg text-muted-foreground">
              Search what you want to do. The app scores places by your words, starting area, interests, budget, and route fit.
            </p>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[360px_1fr]">
          <aside ref={preferencesRef} className="space-y-4 lg:sticky lg:top-24 lg:self-start">
              ...
              <div className="mt-5 space-y-4">
                ...
                >
                  <label className="block">
                    <span className="text-sm font-semibold text-muted-foreground">What are you looking for?</span>
                    <input
                      value={searchInput}
                  ...
                  <p className="text-xs text-muted-foreground">
                    {statusMessage} Nearby radius: up to {maxRouteDistanceKm} km.
                  </p>
                </form>

                <label className="block">
                  <span className="text-sm font-semibold text-muted-foreground">Starting area</span>
                  <select
                    value={startAreaId}
                    onChange={(event) => {
                      setStartAreaId(event.target.value);
                      setSelectedStopId(null);
                      setStatusMessage("Starting area updated. Route recalculated automatically.");
                    }}
                    className="mt-2 h-11 w-full rounded-md border border-input bg-background px-3 font-medium outline-none focus:ring-2 focus:ring-ring"
                  >
                ...
                <div>
                  <span className="text-sm font-semibold text-muted-foreground">Travel interests</span>
                    ...
                    {interestOptions.map((option) => (
                      <button
                        ...
                        onClick={() => {
                          ...
                          setSelectedStopId(null);
                          setStatusMessage(`${option.label} preference updated.`);
                        }}
                ...
                <label className="block">
                  <span className="text-sm font-semibold text-muted-foreground">Route pace</span>
                  <select
                    value={pace}
                    onChange={(event) => {
                ...
                <label className="block">
                  <span className="text-sm font-semibold text-muted-foreground">Budget comfort</span>
                  <select
                    value={budget}
                    onChange={(event) => {
                      setBudget(event.target.value as Budget);
                      setStatusMessage("Budget updated. Place and buddy scores changed.");
                    }}
                    className="mt-2 h-11 w-full rounded-md border border-input bg-background px-3 font-medium outline-none focus:ring-2 focus:ring-ring"
                  >
                ...
                <label className="block">
                  <span className="text-sm font-semibold text-muted-foreground">Preferred language</span>
                  <select
                    value={language}
                    onChange={(event) => {
                      setLanguage(event.target.value);
                      setStatusMessage("Guide and buddy language matching updated.");
                    }}
                    className="mt-2 h-11 w-full rounded-md border border-input bg-background px-3 font-medium outline-none focus:ring-2 focus:ring-ring"
                  >
            ...
            <section className="rounded-xl border border-border bg-card p-5 shadow-sm">
              ...
              <div className="mt-4 space-y-3">
                <label className="flex items-center justify-between gap-4 rounded-lg bg-muted/60 p-3">
                  <span>
                    <span className="block text-sm font-bold">Verified providers only</span>
                    <span className="text-xs text-muted-foreground">ID, passport, face check, and OTP</span>
                  </span>
                  <input
                    type="checkbox"
                    ...
                    onChange={(event) => {
                      ...
                      setStatusMessage(event.target.checked ? "Verification filter enabled." : "Verification filter relaxed for demo.");
                    }}
                ...
                <label className="flex items-center justify-between gap-4 rounded-lg bg-muted/60 p-3">
                  <span>
                    <span className="block text-sm font-bold">Same language buddies</span>
                    <span className="text-xs text-muted-foreground">Match by language and activities</span>
                  </span>
                  <input
                    type="checkbox"
            ...
            <section className="rounded-xl border border-border bg-card p-5 shadow-sm">
              ...
              {savedTrips.length ? (
                <div className="mt-3 space-y-2">
                  {savedTrips.map((trip) => (
                    <button
                      key={trip}
                      type="button"
                      onClick={() => setStatusMessage(`Loaded saved trip preview: ${trip}`)}
                ...
                <p className="mt-2 text-sm text-muted-foreground">Save a generated trip to see it here.</p>
              )}
            </section>
          </aside>
          ...
          <div className="space-y-6">
            <section className="grid gap-4 md:grid-cols-4">
              <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
                <p className="text-sm font-semibold text-muted-foreground">Best match</p>
                <p className="mt-2 text-3xl font-extrabold text-primary">
                  {Math.min(99, Math.max(72, recommendedStops[0]?.match ?? 72))}%
                </p>
                <p className="mt-1 text-sm text-muted-foreground">{searchQuery || topInterests}</p>
              </div>
              <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
                <p className="text-sm font-semibold text-muted-foreground">Route distance</p>
                <p className="mt-2 text-3xl font-extrabold text-accent">{Math.round(totalKm)} km</p>
                <p className="mt-1 text-sm text-muted-foreground">{formatDuration(totalMinutes)} of activities</p>
              </div>
              <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
                <p className="text-sm font-semibold text-muted-foreground">Fair transport</p>
                <p className="mt-2 text-3xl font-extrabold text-secondary">{fairFare.toLocaleString()}</p>
                <p className="mt-1 text-sm text-muted-foreground">THB fixed estimate</p>
              </div>
              <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
                <p className="text-sm font-semibold text-muted-foreground">Buddy pool</p>
                <p className="mt-2 text-3xl font-extrabold text-primary">{matchedBuddies.length}</p>
                <p className="mt-1 text-sm text-muted-foreground">{sameLanguage ? language : "Mixed language"} matches</p>
              </div>
            </section>
            ...
            <section className="rounded-xl border border-border bg-card p-5 shadow-sm">
              <div className="flex flex-col gap-3 border-b border-border pb-5 md:flex-row md:items-center md:justify-between">
                <div>
                  <h2 className="text-2xl font-extrabold">Recommended route from {startArea.name}</h2>
                  <p className="text-muted-foreground">
                    Showing places within {maxRouteDistanceKm} km, ranked by search words, interests, budget, crowd level, and distance.
                  </p>
                </div>
              ...
              {isSearching ? (
                <div className="mt-6 space-y-4">
                  {[0, 1, 2].map((item) => (
                    <div key={item} className="grid gap-4 rounded-lg border border-border bg-background p-3 md:grid-cols-[180px_1fr]">
                ...
                <div className="mt-6 space-y-5">
                  ...
                  <article
                    ...
                    className={`grid gap-4 rounded-lg border bg-background p-3 transition md:grid-cols-[180px_1fr] ${
                      selectedStop?.id === stop.id ? "border-primary shadow-md" : "border-border"
                    }`}
                  >
                    ...
                    <div className="flex flex-col justify-between gap-4 p-1">
                        ...
                        <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                          <div>
                            <p className="text-sm font-bold text-primary">
                              {stop.time} - {formatDuration(stop.duration)} - {stop.area}, {stop.province}
                            </p>
                            <h3 className="mt-1 text-2xl font-extrabold">{stop.title}</h3>
                          </div>
                          <span className="w-fit rounded-full bg-primary/10 px-3 py-1 text-sm font-bold text-primary">
                            {Math.min(stop.match, 99)}% match
                          </span>
                        </div>
                        <p className="mt-3 text-muted-foreground">{stop.description}</p>
                        <p className="mt-3 rounded-lg bg-muted p-3 text-sm">
                          <span className="font-bold">Agent reason:</span> matches {getSharedTags(stop.tags, interests)}, fits{" "}
                          {budget} budget, and is {stop.distanceKm} km from the selected route base.
                        </p>
                        <p className="mt-2 rounded-lg border border-border p-3 text-sm">
                          <span className="font-bold">Local guide tip:</span> {stop.localTip}
                        </p>
                        <div className="mt-2 grid gap-2 text-sm md:grid-cols-3">
                          <div className="rounded-md border border-border p-3">
                            <span className="block text-xs font-bold uppercase text-muted-foreground">Open</span>
                            {getPlaceDetail(stop).hours}
                          </div>
                          <div className="rounded-md border border-border p-3">
                            <span className="block text-xs font-bold uppercase text-muted-foreground">Cost</span>
                            {getPlaceDetail(stop).price}
                          </div>
                          <div className="rounded-md border border-border p-3">
                            <span className="block text-xs font-bold uppercase text-muted-foreground">Best time</span>
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        {stop.tags.map((tag) => (
                          <span key={tag} className="rounded-full border border-border px-3 py-1 text-xs font-semibold capitalize">
                            {tag}
                          </span>
                        ))}
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            setStatusMessage(`Showing details for ${stop.title}.`);
                          }}
              ...
              <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
                ...
                <div className="mt-4 space-y-3">
                  {matchedGuides.map((guide) => (
                    <div key={guide.name} className="rounded-lg bg-muted/60 p-4">
                      ...
                      <p className="mt-2 text-sm">Languages: {guide.languages.join(", ")}</p>
                      <p className="text-sm">Rate: {guide.rate.toLocaleString()} THB/day</p>
                      <p className="text-xs text-muted-foreground">Identity: {guide.verification}</p>
                      <button
                        type="button"
                ...
                <div className="mt-4 space-y-3">
                  <div className="rounded-lg bg-muted/60 p-4">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Upfront fare, verified driver identity, OTP pickup, and route-aware stops.
                    </p>
                    <button
                      type="button"
                      onClick={bookDriver}
                  ...
                  <div className="rounded-lg bg-muted/60 p-4">
                    ...
                    <div className="mt-3 space-y-2">
                      {matchedBuddies.map((buddy) => (
                        ...
                        >
                          <span className="block font-bold">{buddy.name} - {buddy.nationality}</span>
                          <span className="text-sm text-muted-foreground">
                            {buddy.language} - {buddy.tags.join(", ")} - {buddy.budget} budget
                          </span>
                        </button>
                      ))}
                    </div>
                  ...
                  <div className="rounded-lg bg-muted/60 p-4">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Places with local tips and high hidden-gem scores can be promoted into the destination platform after guide verification.
                    </p>
                    <button
                      type="button"
                      onClick={() => setStatusMessage("Unseen listing draft created for the highest scoring hidden place.")}
                      className="mt-3 rounded-md bg-primary px-3 py-2 text-sm font-bold text-primary-foreground"
                    >
          ...
          <div className="max-h-[92vh] w-full max-w-4xl overflow-y-auto rounded-xl bg-background shadow-2xl">
            ...
            <div className="p-5 md:p-6">
              <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                <div>
                  <p className="text-sm font-bold text-primary">
                    {selectedStop.area}, {selectedStop.province} - {selectedStop.distanceKm} km from {startArea.name}
                  </p>
                  <h2 className="mt-1 text-3xl font-extrabold">{selectedStop.title}</h2>
                  <p className="mt-2 text-muted-foreground">{selectedPlaceDetail.address}</p>
                </div>
                <span className="w-fit rounded-full bg-primary/10 px-3 py-1 text-sm font-bold text-primary">
              ...
              <div className="mt-5 grid gap-4 lg:grid-cols-[1fr_1fr]">
                <div className="rounded-lg border border-border p-4">
                  ...
                  <p className="mt-3 text-sm">
                    <span className="font-bold">Accessibility:</span> {selectedPlaceDetail.accessibility}
                  </p>
                  <p className="mt-2 text-sm">
                    <span className="font-bold">Transport:</span> {selectedPlaceDetail.transportNote}
                  </p>
                  <p className="mt-2 text-sm">
                    <span className="font-bold">Local tip:</span> {selectedStop.localTip}
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-border p-4">
                  ...
                  <p className="mt-3 text-sm text-muted-foreground">
                    The rule-based search matched {getSharedTags(selectedStop.tags, interests)}, kept the stop within the {maxRouteDistanceKm} km radius,
                    and checked it against your {budget} budget preference.
                  </p>
              ...
              <div className="mt-5">
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  {selectedPlaceDetail.highlights.map((highlight) => (
                    <span key={highlight} className="rounded-full bg-primary/10 px-3 py-1 text-xs font-bold text-primary">
                      {highlight}
                    </span>
                  ))}
                </div>
              ...
              <div className="mt-5 rounded-lg bg-muted/70 p-4">
                ...
                <p className="mt-1 text-sm text-muted-foreground">{selectedPlaceDetail.nearby.join(", ")}</p>
              </div>

              <div className="mt-5 flex flex-wrap gap-2">
                <button
                  type="button"
                  onClick={() => setStatusMessage(`${selectedStop.title} added to a custom route draft.`)}
                ...
                <button
                  type="button"
                  onClick={() => setStatusMessage(`Mock booking note saved for ${selectedStop.title}.`)}
                ...
                <button
                  type="button"
                  onClick={() => setStatusMessage(`Fair ride preview opened for ${selectedStop.title}.`)}
                  className="rounded-md border border-border px-4 py-2 text-sm font-bold hover:border-primary"
                >
                  Preview ride
                </button>
